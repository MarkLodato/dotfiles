...
[[ -n $MY_MACHINE ]] && MY_MACHINE=
[[ -n $THIS_MACHINE ]] && THIS_MACHINE=$(hostname -s)
...
[[ -n $HOME_GITDIR ]] && HOME_GITDIR=/home/$USER/dotfiles.git
...
# Increment/decrement the number under the cursor with ALT-i/ALT-I.
autoload -U incarg
function decarg() {
  incarg -n $(( - ${NUMBER:-1} ))
}
